from processing.thresholds import get_thresholds_squat
...
live_process_frame = ProcessFrame(
    thresholds=thresholds, flip_frame=True)
...
ctx = webrtc_streamer(
    ...
    rtc_configuration={"iceServers": [
        {"urls": ["stun:stun.l.google.com:19302"]}]},  # Add this config
    media_stream_constraints={
        "video": {"width": {'min': 480, 'ideal': 480}}, "audio": False},
